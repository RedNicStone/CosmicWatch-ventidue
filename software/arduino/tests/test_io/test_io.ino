...
void drawFrame() {
  ...
  Paint_DrawCircle(105, 45, 10, WHITE, DOT_PIXEL_1X1, previousButtonState ? DRAW_FILL_FULL : DRAW_FILL_EMPTY);
  ...
  Paint_DrawLine(105 + deltaX1, 45 - deltaY1, 105 + deltaX2, 45 - deltaY2, previousButtonState ? BLACK : WHITE, DOT_PIXEL_1X1, LINE_STYLE_SOLID);
}

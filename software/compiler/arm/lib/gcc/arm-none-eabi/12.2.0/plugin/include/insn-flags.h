...
#define HAVE_pac_nop (arm_arch7 && arm_arch_cmse)
#define HAVE_pacbti_nop (arm_arch7 && arm_arch_cmse)
#define HAVE_aut_nop (arm_arch7 && arm_arch_cmse)
#define HAVE_bti_nop (arm_arch7 && arm_arch_cmse)
